...
Base tecnica: Plataforma e Infra + padrao de erros + validacao Zod + repositorios base.
Identidade: Usuarios + Autenticacao + ajustes de seguranca.
Governanca: Estudos + Autorizacao por Estudo (RBAC).
Cadastro clinico: Participantes + Participacao em Estudos.
Dicionario do estudo: Tipos de Visita + Variaveis.
Coleta longitudinal: Visitas + Medicoes.
Leitura/Exportacao: Consultas e Exportacao + refinamentos de rastreabilidade.
